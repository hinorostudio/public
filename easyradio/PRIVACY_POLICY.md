...
- **Advertising:** When you use the free version of the app, Google AdMob may collect device and usage data (such as device ID, IP address, and ad interaction data) to deliver and measure ads. This is governed by [Google's Privacy Policy](https://policies.google.com/privacy) and [Google's Ads policies](https://policies.google.com/technologies/ads).
...
- To process in-app purchases (e.g. premium / no ads) through Google Play Billing; payment and purchase data are handled by Google according to [Google Play's terms and privacy](https://policies.google.com/privacy).
...
| **Google Play**    | App distribution, in-app purchases | [Google Play terms](https://play.google.com/about/play-terms/) |
...
- **Ads:** In the free version, ads are shown via AdMob; you can limit ad personalisation in your [Google account ad settings](https://adssettings.google.com/).
- **No ads:** You can purchase the premium version to remove ads (Google Play Billing).
- **Access, deletion, portability:** We do not maintain user accounts or central user databases. For AdMob and Google Play data, you can use Google's tools and policies (e.g. [Google Privacy & Terms](https://policies.google.com/)).
...
*EasyRadio stores your favorites and preferences only on your device. The free version uses Google AdMob for ads; the station catalogue is provided by Radio Browser. We do not sell your data.*
